"""JIT compilation of the TTS megakernel CUDA extension."""
...
KERNEL_FLAGS = [
    ...
    f"-DLDG_TTS_VOCAB_SIZE={_env_int('LDG_TTS_VOCAB_SIZE', 3072)}",
...
def get_extension():
    ...
    _module = load(
        ...
        sources=[
            os.path.join(_CSRC, "torch_bindings_tts.cpp"),
            os.path.join(_CSRC, "kernel_tts.cu"),
        ],
